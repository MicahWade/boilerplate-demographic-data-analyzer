...
def calculate_demographic_data(print_data=True):
    ...
    rich_counts = rich_people["native-country"].value_counts().sort_index()
    total_counts = df["native-country"].value_counts().sort_index()
    percentages = 100 * (rich_counts / total_counts)
